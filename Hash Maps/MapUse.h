// Implementing HashMaps Using Separate Chaining (Closed Addressing)
// Each Entry of Bucket Array contains Head of a LinkedList
// Using strings as key
// Using Rehashing to maintain Load Factor
// Load Factor --> Number of Entries in HashMap / total number of buckets (size of bucket Array)
// If Load Factor > 0.7 , we will need to Rehash
